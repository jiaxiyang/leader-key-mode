...
(defvar leader-key-mode-keymap
  (let ((m (make-sparse-keymap)))
    ...
    (define-key m (leader-key-mode-kbd "2") '(lambda () (interactive)(split-window-below) (other-window 1)))
    (define-key m (leader-key-mode-kbd "3") '(lambda () (interactive)(split-window-right) (other-window 1)))
